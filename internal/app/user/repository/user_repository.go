...
func (r *userRepository) GetAllUsers(ctx context.Context) ([]model.User, error) {
	...
	r.log.LogInternal(ctx, "repository", "GetAllUsers", "Retrieving all users")
...
func (r *userRepository) GetUserByID(ctx context.Context, id string) (*model.User, error) {
	...
	r.log.LogInternal(ctx, "repository", "GetUserByID", "Retrieving user by ID", id)
...
func (r *userRepository) CreateUser(ctx context.Context, user *model.User) error {
	...
	r.log.LogInternal(ctx, "repository", "CreateUser", "Creating user", user)
...
func (r *userRepository) UpdateUser(ctx context.Context, user *model.User) error {
	...
	r.log.LogInternal(ctx, "repository", "UpdateUser", "Updating user", user)
...
func (r *userRepository) DeleteUser(ctx context.Context, id string) error {
	r.log.LogInternal(ctx, "repository", "DeleteUser", "Deleting user by ID", id)
